 ...
 * {@link RecentFriendsActFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RecentFriendsActFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RecentFriendsActFragment extends Fragment {
    ...
    public RecentFriendsActFragment() {
    ...
    public static RecentFriendsActFragment newInstance(String param1, String param2) {
        RecentFriendsActFragment fragment = new RecentFriendsActFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TourListTemp.clear();
        TourListTemp = Controllers.getRecentList();
        DealList.clear();
